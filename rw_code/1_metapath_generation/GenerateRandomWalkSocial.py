...
class GenerateRandomWalkSocial:    
    def __init__(self,filepath,trust):
        ...
        print 'len: ', len(self.user_lst),len(self.item_lst)
        #print(self.user_item_dict[0],self.user_item_dict[1])
        #print self.user_item_dict
        
    def generate_walks(self, outfilename, numwalks, walklength,metapath='US',min_len_to_keep=5):
    ...
    def generate_walks_social(self, outfilename, numwalks, walklength,metapath='US',min_len_to_keep=5):
        print("generate walks social")
    ...
    def get_instances_for_metaclass(self, prv, cur,inst,first_flag):
        ...
        if prv == 'S' and cur == 'U':
            ...
            if self.trust == True:
                ...
                return (item_lst[itemid],'S' + str(item_lst[itemid]))
